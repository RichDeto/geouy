...
metadata <- data.frame(
        rbind(c("Uruguay", "INE", "MIDES", 32721, "wfs", 2011, 
                ...
                "gml_id", NA),
              c("Areas administrativas", "SGM", "SGM", 4326, "wfs", 2011, "polnbda_ury", NA, NA),
              ...
              c("Secc MVD 2004", "INE", "MIDES", 32721, "wfs", 2004,
                "https://mapas.mides.gub.uy/geoserver/INECenso2004/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2004:mvdsecc04",
                "CODSEC","SECCION"),
              c("Segm MVD 2004", "INE", "MIDES", 32721, "wfs", 2004,
                "https://mapas.mides.gub.uy/geoserver/INECenso2004/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2004:mvdseg04",
                "CODSEG","SEGMENTO"),
              c("Zonas MVD 2004", "INE", "MIDES", 32721, "wfs", 2004,
                "https://mapas.mides.gub.uy/geoserver/INECenso2004/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2004:zonas04mvd",
                "CODCOMP","ZONA"),
              c("Segmentos URB INT 2004", "INE", "MIDES", 32721, "wfs", 2004,
                "https://mapas.mides.gub.uy/geoserver/INECenso2004/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2004:seg04_int",
                "CODSEG","SEGMENTO"),
              c("Zonas URB INT 2004", "INE", "MIDES", 32721, "wfs", 2004,
                "https://mapas.mides.gub.uy/geoserver/INECenso2004/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2004:zonas04_int",
                "CODCOMP","ZONA"),
              ...
              c("Localidades pt", "INE", "MIDES", 32721, "wfs", 2011,
                "https://mapas.mides.gub.uy:443/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2004:Localidades_pt",
                "CODLOC","NOMBLOC"),
