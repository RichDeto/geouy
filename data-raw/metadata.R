...
metadata <- tibble::tribble(
  ...
  "Departamentos", "IDE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/IDE/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=IDE:departamentos_v2", "uruguay_", "nombre", "UTF-8",
  ...
  "Localidades pt", "INE", "MIDES", 32721, "zip", 2011, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso:Localidades_pg&outputFormat=SHAPE-ZIP", "CODLOC","NOMBLOC", "UTF-8",
