...
metadata <- tibble::tribble(
  ...
  "Departamentos", "INE", "IDE", 32721, "wfs", 2011, "https://mapas.ide.uy/geoserver-vectorial/INE_NO_SEGURO/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=ine_depto", "depto", "nombre",
